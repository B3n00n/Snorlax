...
class PacketWriter:    
    ...
    def write_ascii_string(self, value: str) -> None:
...
class PacketReader:    
    ...
    def read_u8(self) -> int:
        if self.offset + 1 > len(self.data):
            raise ValueError("Not enough data to read u8")
    ...
    def read_u16(self) -> int:
        if self.offset + 2 > len(self.data):
            raise ValueError("Not enough data to read u16")
    ...
    def read_u32(self) -> int:
        if self.offset + 4 > len(self.data):
            raise ValueError("Not enough data to read u32")
    ...
    def read_ascii_string(self) -> str:
        ...
        if self.offset + length > len(self.data):
            raise ValueError(f"Not enough data to read ASCII string of length {length}")
